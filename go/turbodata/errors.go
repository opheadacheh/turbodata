...
var (
	...
	// ErrTopicNameAlreadyOpened is returned by OpenTopics when a topic name has
	// already been opened by this Writer (in this or an earlier group), or when
	// the same name appears more than once in a single OpenTopics call. Each
	// topic name must be unique for the lifetime of a Writer.
	ErrTopicNameAlreadyOpened = errors.New("topic name already opened")
